...
const swaggerUIHTML = (specUrl: string, title: string = 'API Documentation') => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const redocHTML = (specUrl: string, title: string = 'API Documentation') => `
<!DOCTYPE html>
<html>
<head>
    <title>${title}</title>
 ...
 */
export const serveOpenApiSpec = (req: Request, res: Response) => {
 ...
 */
export const documentRoute = (operation: any) => {
 ...
 */
export const docsAuth = (req: Request, res: Response, next: NextFunction) => {
