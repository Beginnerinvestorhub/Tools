...
const gamificationPaths: OpenAPIV3.PathsObject = {
...
const newsletterPaths: OpenAPIV3.PathsObject = {
...
const stripePaths: OpenAPIV3.PathsObject = {
...
const adminPaths: OpenAPIV3.PathsObject = {
  '/api/admin/users': {
    get: {
      tags: ['Admin'],
...
const healthPaths: OpenAPIV3.PathsObject = {
  '/api/health': {
    get: {
      tags: ['Health'],
...
export const completeApiSpec: OpenAPIV3.Document = {
  ...openApiSpec,
  paths: {
    ...authPaths,
    ...profilePaths,
...
export default completeApiSpec;
