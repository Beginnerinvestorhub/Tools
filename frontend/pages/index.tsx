    ...
    <Layout>
      ...
      <main className="flex flex-col items-center justify-center flex-1 px-4 text-center max-w-4xl mx-auto py-12">
        ...
        <section className="w-full max-w-6xl my-12">
          <div className="bg-white/90 backdrop-blur-sm rounded-lg p-4 mb-8 shadow-lg">
          <h2 className="text-2xl font-semibold text-indigo-800 text-center">Empowering Your Investment Journey</h2>
        </div>
